...
var radioWaves = {
	minsk: [
		{ name: "Радио Relax", wave: 87.5 },
		{ name: "Народное радио", wave: 87.9 },
		{ name: "Радио Шансон", wave: 90.9 },
		{ name: "Радио Минск", wave: 92.4 },
		{ name: "Europa plus", wave: 92.8 },
		{ name: "Юмор FM", wave: 93.7 },
		{ name: "Легенды FM", wave: 94.1 },
		{ name: "Мелодии Века", wave: 96.2 },
		{ name: "Ретро (не вещает)", wave: 96.9 },
		{ name: "Минская волна", wave: 97.4 },
		{ name: "Авторадио", wave: 98 },
		{ name: "Новое радио", wave: 98.4 },
		{ name: "Русское радио", wave: 98.9 },
		{ name: "Unistar", wave: 99.5 },
		{ name: "Energy (NRJ)", wave: 100.4 },
		{ name: "Пилот FM", wave: 101.2 },
		{ name: "Центр FM", wave: 101.7 },
		{ name: "Радио Рокс", wave: 102.1 },
		{ name: "Компас FM", wave: 102.5 },
		{ name: "Канал \"Культура\"", wave: 102.9 },
		{ name: "Радиус FM", wave: 103.7 },
		{ name: "Супер FM (бывш. Радио BA)", wave: 104.6 },
		{ name: "Радио Столица", wave: 105.1 },
		{ name: "Душевное радио", wave: 105.7 },
		{ name: "Первый национальный канал", wave: 106.2 },
		{ name: "Радио Мир", wave: 107.1 },
		{ name: "Альфа Радио", wave: 107.9 },
	],
	molodechno: [
		...
		{ name: "Новое радио", wave: 100.6 },
		{ name: "Минская волна", wave: 107.4 },
	],
	smorgon: [
		{ name: "Радио Столица", wave: 66.38 },
		{ name: "Радио Гродно", wave: 67.19 },
		{ name: "Першы Канал", wave: 67.97 },
		{ name: "Канал \"Культура\"", wave: 70.13 },
		{ name: "—", wave: 88 },
		{ name: "Юмор FM", wave: 91 },
		{ name: "Новое радио", wave: 92.1 },
		{ name: "Радио Столица", wave: 94.4 },
		{ name: "—", wave: 97.7 },
		{ name: "—", wave: 99.2 },
		{ name: "Радиус FM", wave: 101.4 },
		{ name: "Радио Гродно", wave: 102.8 },
		{ name: "Першы Канал", wave: 103.6 },
		{ name: "—", wave: 106.1 },
	],
	myadzel: [
		{ name: "Радио Столица", wave: 66.86 },
		{ name: "Радио Витебск", wave: 67.64 },
		{ name: "Першы Канал", wave: 68.69 },
		{ name: "Канал \"Культура\"", wave: 70.31 },
		{ name: "Новое радио", wave: 90.5 },
		{ name: "—", wave: 91.3 },
		{ name: "—", wave: 93.1 },
		{ name: "Unistar", wave: 94.8 },
		{ name: "Радио Столица", wave: 98.5 },
		{ name: "Радио Беларусь", wave: 102 },
		{ name: "Минская волна", wave: 102.4 },
		{ name: "Радиус FM", wave: 103.9 },
		{ name: "Канал \"Культура\"", wave: 104.9 },
